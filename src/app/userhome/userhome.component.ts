...
export class UserhomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    setTimeout(()=>{
      ...
      this.couchdblogsService.putErrorInPouch("ngOnInit()","Initialized web3 instances","Successfully initialized, cas distributor ready to transfer tokens.","4","UserhomeComponent","log");
    },1000)
  ...
  setTimeIn(){
    ...
    //       console.log('hello',+i);
    //       console.log(_.nth(data,i));           //  your code here
  ...
  panelbtn(arg){
    ...
    if(arg == 1 ){
      ...
      this.couchdblogsService.putErrorInPouch("panelbtn()","Navigate to multiple token transfer panel","","4","UserhomeComponent","info");
    }else if(arg == 2){
      this.singleaddress = "";
      this.singlefromaddress = "";
      this.singletokens = "";
      this.couchdblogsService.putErrorInPouch("panelbtn()","Navigate to single token transfer panel","","4","UserhomeComponent","info");
    }
  }
    ...
    try{
      ...
      if(ConstantsService.validateHeaderAndRecordLengthFlag){
        if(!this._fileUtil.isCSVFile(files[0])){
          ...
          this.fileReset();
          this.couchdblogsService.putErrorInPouch("fileChangeListener()","File uploaded is not a csv file","","4","UserhomeComponent","error");
        }  
      }
      ...
      reader.onload = (data) => {
        ...
        if(this.csvRecords == null){
          ...
          if(size > 1000){
            ...
            this.fileReset();
            this.couchdblogsService.putErrorInPouch("fileChangeListener()","CSV file limit exceed","","4","UserhomeComponent","warning");
          }else{
      ...
      reader.onerror = () => {
        ...
        this.couchdblogsService.putErrorInPouch("fileChangeListener()","CSV file unable to read","","4","UserhomeComponent","error");
      };
    }catch(e){
      // console.log("error",e)
      ...
      this.couchdblogsService.putErrorInPouch("fileChangeListener()","File upload error caught",JSON.stringify(e),"4","UserhomeComponent","error");
    }
  ...
  uploadcsv(){
    if(this.uploadForm.valid){
      // this.couchdblogsService.putErrorInPouch("uploadcsv()","Trying to send multiple token transfer",JSON.stringify(this.uploadForm.value),"4","UserhomeComponent","info");
      ...
      if(a==1){
        ...
        this.couchdblogsService.putErrorInPouch("uploadcsv()",'The file content is wrong.'+this.recordTOSendMsg1+this.recordTOSendMsg2+' Correct it.',"","5","UserhomeComponent","error");
      } 
  ...
  openModal(){
    ...
    // this.couchdblogsService.putErrorInPouch("openModal()","Modal open for multiple token transfer","","3","UserhomeComponent","log");
  }
  ...
  calculatingFee(){ // its call after contract deployed
    try{
      ...
      // this.couchdblogsService.putErrorInPouch("calculatingFee()","Registering the transfer detail","","4","UserhomeComponent","log");
            ...
            (d)=>{
              ...
              .then(
                val=>{
                  ...
                  this.openModal(); 
                  this.couchdblogsService.putErrorInPouch("calculatingFee()","All details has been taken successfully to display in multiple transfer",JSON.stringify({balnace:val,fromwei:fromwei}),"6","UserhomeComponent","success");
                }
              )
  ...
  contractDetails(){
    ...
    if(existabi == null || existabi == ""){
      ...
      let abi = this.mycryptoService.abi;//[{"constant": true, "inputs": [], "name": "name", "outputs": [{"name": "", "type": "string"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "_spender", "type": "address"}, {"name": "_value", "type": "uint256"} ], "name": "approve", "outputs": [{"name": "", "type": "bool"} ], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [], "name": "totalSupply", "outputs": [{"name": "", "type": "uint256"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "_from", "type": "address"}, {"name": "_to", "type": "address"}, {"name": "_value", "type": "uint256"} ], "name": "transferFrom", "outputs": [{"name": "", "type": "bool"} ], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [], "name": "decimals", "outputs": [{"name": "", "type": "uint256"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "burnAmount", "type": "uint256"} ], "name": "burn", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": false, "inputs": [{"name": "value", "type": "uint256"} ], "name": "upgrade", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": false, "inputs": [{"name": "_name", "type": "string"}, {"name": "_symbol", "type": "string"} ], "name": "setTokenInformation", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [], "name": "upgradeAgent", "outputs": [{"name": "", "type": "address"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [], "name": "releaseTokenTransfer", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [], "name": "upgradeMaster", "outputs": [{"name": "", "type": "address"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "_spender", "type": "address"}, {"name": "_subtractedValue", "type": "uint256"} ], "name": "decreaseApproval", "outputs": [{"name": "success", "type": "bool"} ], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [], "name": "releaseFinalizationDate", "outputs": [{"name": "", "type": "uint256"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [{"name": "_owner", "type": "address"} ], "name": "balanceOf", "outputs": [{"name": "balance", "type": "uint256"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [], "name": "getUpgradeState", "outputs": [{"name": "", "type": "uint8"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [], "name": "symbol", "outputs": [{"name": "", "type": "string"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [], "name": "released", "outputs": [{"name": "", "type": "bool"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [], "name": "canUpgrade", "outputs": [{"name": "", "type": "bool"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "_to", "type": "address"}, {"name": "_value", "type": "uint256"} ], "name": "transfer", "outputs": [{"name": "success", "type": "bool"} ], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [], "name": "totalUpgraded", "outputs": [{"name": "", "type": "uint256"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "_spender", "type": "address"}, {"name": "_addedValue", "type": "uint256"} ], "name": "increaseApproval", "outputs": [{"name": "success", "type": "bool"} ], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": false, "inputs": [{"name": "agent", "type": "address"} ], "name": "setUpgradeAgent", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [{"name": "_owner", "type": "address"}, {"name": "_spender", "type": "address"} ], "name": "allowance", "outputs": [{"name": "remaining", "type": "uint256"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [], "name": "isToken", "outputs": [{"name": "weAre", "type": "bool"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": true, "inputs": [], "name": "BURN_ADDRESS", "outputs": [{"name": "", "type": "address"} ], "payable": false, "stateMutability": "view", "type": "function"}, {"constant": false, "inputs": [{"name": "master", "type": "address"} ], "name": "setUpgradeMaster", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"inputs": [{"name": "_owner", "type": "address"}, {"name": "_name", "type": "string"}, {"name": "_symbol", "type": "string"}, {"name": "_totalSupply", "type": "uint256"}, {"name": "_decimals", "type": "uint256"}, {"name": "_releaseFinalizationDate", "type": "uint256"} ], "payable": false, "stateMutability": "nonpayable", "type": "constructor"}, {"anonymous": false, "inputs": [{"indexed": false, "name": "newName", "type": "string"}, {"indexed": false, "name": "newSymbol", "type": "string"} ], "name": "UpdatedTokenInformation", "type": "event"}, {"anonymous": false, "inputs": [{"indexed": true, "name": "_from", "type": "address"}, {"indexed": true, "name": "_to", "type": "address"}, {"indexed": false, "name": "_value", "type": "uint256"} ], "name": "Upgrade", "type": "event"}, {"anonymous": false, "inputs": [{"indexed": false, "name": "agent", "type": "address"} ], "name": "UpgradeAgentSet", "type": "event"}, {"anonymous": false, "inputs": [{"indexed": false, "name": "burner", "type": "address"}, {"indexed": false, "name": "burnedAmount", "type": "uint256"} ], "name": "Burned", "type": "event"}, {"anonymous": false, "inputs": [{"indexed": true, "name": "owner", "type": "address"}, {"indexed": true, "name": "spender", "type": "address"}, {"indexed": false, "name": "value", "type": "uint256"} ], "name": "Approval", "type": "event"}, {"anonymous": false, "inputs": [{"indexed": true, "name": "from", "type": "address"}, {"indexed": true, "name": "to", "type": "address"}, {"indexed": false, "name": "value", "type": "uint256"} ], "name": "Transfer", "type": "event"} ];
      let bytecode = this.mycryptoService.bytecode;//'';
      ...
      this.mycryptoService.saveToLocal("SISContractAddress",this.mycryptoService.contractAddress);//"0xe8780B48bdb05F928697A5e8155f672ED91462F7");
    }else{ 
  ...
  saveNewDetail(){
    ...
    this.mycryptoService.saveToLocal("SISUAddress",this.mycryptoService.localAddress);
    this.mycryptoService.saveToLocal("SISUPrivateKey",this.mycryptoService.localPKey);
    this.mycryptoService.saveToLocal("SISContractAddress",this.mycryptoService.contractAddress);
  ...
  singlenext(){
    ...
    if(this.singleaddress == null || this.singleaddress == ""){
      ...
      try{
        this.mycryptoService.saveToLocal("SISContractAddress",this.mycryptoService.contractAddress);//"0x11dc5a650e1e2a32c336fa73439e7cc035976c06");//"0xe8780B48bdb05F928697A5e8155f672ED91462F7");
              ...
              (d)=>{
                ...
                .then(
                  val=>{
                    ...
                    this.couchdblogsService.putErrorInPouch("singlenext()","All details has been taken successfully to display in single transfer",JSON.stringify({balnace:val,fromwei:fromwei}),"6","UserhomeComponent","success");
                  }
                )
  ...
  openModalForSingle(){
    ...
    // this.couchdblogsService.putErrorInPouch("openModalForSingle()","Modal open for single token transfer","","3","UserhomeComponent","log");
  }
  ...
  dothese(event){
    ...
    .then(
      d=>{
        ...
        this.couchdblogsService.putErrorInPouch("dothese()","Downloaded a sample csv file","","3","UserhomeComponent","log");
      },
      e=>{
        // console.log(e) 
        this.logServ.putErrorInPouch("dothese()","File unable to read","Some issue with uploaded file,"+JSON.stringify(e),"1");
        this.couchdblogsService.putErrorInPouch("dothese()","Sample file unable to read",JSON.stringify(e),"3","UserhomeComponent","error");
        this.snackBar.open('Sample CSV file unable to download','',{
          duration:2000
        });
      }
