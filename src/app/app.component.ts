...
export class AppComponent {
  ...
  ngOnInit(){
    ...
    this.mycryptoService.saveToLocalURL("SISWEB3URL","https://ropsten.infura.io/2H9y3HfwB9FOuy0Gqr4m");//"https://mainnet.infura.io/2H9y3HfwB9FOuy0Gqr4m");//"http://139.59.213.205:7007");//"http://127.0.0.1:8008");
