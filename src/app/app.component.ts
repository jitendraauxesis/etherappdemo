...
export class AppComponent {
  ...
  ngOnInit(){
    // let SISKeystore = this.mycryptoService.InitKeyGet();
    ...
    // this.mycryptoService.saveToLocal("ViewTransactionAddressURL","https://etherscan.io/address/");
    // this.mycryptoService.saveToLocal("ViewTransactionHashURL","https://etherscan.io/tx/");
    // this.mycryptoService.saveToLocal("ViewTransactionHashURL","https://etherscan.io/tx/");
    ...
    let isStored = this.mycryptoService.retrieveFromLocalURL("SISWEB3URL");
    if(isStored == null || isStored ==undefined || isStored == "" || !isStored){
      this.mycryptoService.saveInitVars();
    }else{
      // console.log("already",isStored)
    }
